...
public interface SubstanceMapper{
    ...
    @Mapping(source = "messageBitSize", target = "messageBitSize")
    @Mapping(source = ".", target = "parameterEntity")
    Substance<ReportEntity> convert(ParameterEntity parameterEntity);

    @Mapping(source = "lambdas", target = "lambdas")
    @Mapping(source = "rangeIterator", target = "rangeIterator")
    @Mapping(source = "startRange", target = "startRange")
    Substance<ReportEntity> convert(HyperParameterConfiguration hyperParameterConfiguration);
    ...
    Substance<HealthDataEntity> convertMulti(ParameterEntity parameterEntity, HyperParameterConfiguration hyperParameterConfiguration);
}
